...
class BotMessageAccumulator:
    ...
    def _store_tool_call_result(self, result_text: str) -> None:
        ...
        if tool_result.get("description") and not tool_call.get("description"):
            tool_call["description"] = tool_result.get("description")
        if tool_result.get("schema") and not tool_call.get("schema"):
            tool_call["schema"] = tool_result.get("schema")
        self.parts.append({"type": "tool_call", "tool_calls": [tool_call]})
